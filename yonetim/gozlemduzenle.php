                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
										...
										<?php 
$query =  $db->stmt_init();
$query = $db->query('select * from compliments order by status desc,id desc');
...
while($obj = $query->fetch_object()){ 
            ...
            echo "<tr><td>".$obj->topic."</td><td>".$obj->desc."</td><td>".$obj->vote."</td><td><a href='#' data-lat='".$obj->coorx."' data-lng='".$obj->coory."' class='btnShow'>Haritada Göster</a></td><td>".$status."</td><td><a href='gozlemdegistir.php?id=".$obj->id."' class='btn btn-outline sbold green-haze'>DÜZENLE</a></td></tr>";
        } 	
										?>
